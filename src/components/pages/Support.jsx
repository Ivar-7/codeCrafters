          ...
          <div className="inner">
            ...
            <ul className="features">
              <li>
                ...
                <span>
                  <strong>Excluisve</strong> package
                </span>
              </li>
              <li>
                <span className="icon">
                ...
                <span>
                  AI <strong>recommendations</strong>
                </span>
              </li>
              <li>
                <span className="icon">
                ...
                <span>
                  Expert <strong>consultations</strong>
                </span>
              </li>
            </ul>
          ...
          <div className="inner">
            ...
            <ul className="features">
              ...
              <li>
                ...
                <span>
                  Priority <strong>support</strong>
                </span>
              </li>
              <li>
                <span className="icon">
          ...
          <div className="inner">
            ...
            <ul className="features">
              ...
              <li>
                ...
                <span>
                  Advanced <strong>analytics</strong>
                </span>
              </li>
              <li>
                <span className="icon">
              ...
              <li>
                ...
                <span>
                  Custom <strong>consultations</strong>
                </span>
              </li>
              <li>
                <span className="icon">
                ...
                <span>
                  Exclusive <strong>workshops</strong>
                </span>
              </li>
            </ul>
            <div className="action">
